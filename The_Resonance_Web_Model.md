...
> **Provenance caveat.** This interest-rate cascade is the author's own **recalled** framing. A primary-source search — the 2025-05-08 origin thread plus the highest-probability 2024 exports (Feb–Jun 2024, chosen by full-text hits on "borrowing power" / "higher interest rates") — **did not find it in Shawn's own words** in any of them; the cascade vocabulary appears only in AI-authored summaries. In the documented origin the model is framed instead as *vibration/convergence across threads* in an investing context (§3). The interest-rate cascade is therefore best read as the author's **2026 synthesizing framing / generalization** of that idea — retained here as a faithful **illustration of the model's logic**, not a sourced quotation. (A full sweep of all ~150 archive exports was not performed.)
...
| ChatGPT export archive, 2024 `*_threads.json` (Feb–Jun 2024, high-probability files) | **Searched for the interest-rate cascade in Shawn's words — not found** (cascade vocabulary only in AI summaries). See §1 caveat. |

> **Provenance note.** The spider-web passages in §3 are quoted **verbatim** from the 2025-05-08 origin thread (raw ChatGPT export). The interest-rate cascade in §1/§2 is the author's **recalled** illustration; it was **searched for across the 2025-05-08 origin thread and the highest-probability 2024 exports and not located in Shawn's own words** (it appears only in AI-authored summaries), so it is presented as an illustration of the model's logic — most plausibly the author's 2026 generalization — not as a sourced quotation. All engineering states, phase results, and the honest validation status in §7–§10 are taken directly from the canonical project memories and reported without embellishment.
